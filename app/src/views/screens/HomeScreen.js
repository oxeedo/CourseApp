...
const HomeScreen = ({ navigation }) => {
    const CourseCard = ({ course }) => {
        return <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate("CourseScreen", { data: course })}>
            <ImageBackground source={course.image} style={{
                ...
                height: windowHeight / 3, overflow: "hidden",
                paddingTop: 25,
                paddingLeft: 20,
                borderRadius: 15
            }}>
    ...
    return <SafeAreaView style={{
        ...
        <View style={{ marginTop: -10 }}>
            <Text style={{ fontSize: 28, fontWeight: 'bold' }}>Hey Gabi,</Text>
            <Text style={{ fontSize: 22, color: "#61688B", marginTop: 15 }}>
                Find a course you want to learn</Text>
            <View style={{
                height: 60,
                marginTop: 35,
                paddingTop: 10,
            ...
            <View style={{
                paddingVertical: 25, flexDirection: "row",
